...
import kr.co.tje.ilovelgtwins.adapter.NoticeAndEventAdapter;
import kr.co.tje.ilovelgtwins.adapter.PostAdapter;
import kr.co.tje.ilovelgtwins.data.News;
import kr.co.tje.ilovelgtwins.data.NoticeAndEvent;
import kr.co.tje.ilovelgtwins.util.GlobalData;
